# Chrome Web Store — Store Description
...
PRIVACY
- No data is stored on any server — everything is ephemeral
- No tracking, no analytics, no cookies
- No login or account required
- Only accesses Google Slides pages — nothing else
- Full privacy policy: https://slidesync.live/privacy/

CREDITS
Inspired by Remote for Slides by Henry Lim (limhenry.xyz/slides/)

Open source: https://github.com/thiavila/slide-sync
```
...
PRIVACIDADE
- Nenhum dado e armazenado em servidor — tudo e efemero
- Sem rastreamento, sem analytics, sem cookies
- Sem login ou conta necessaria
- Acessa apenas paginas do Google Slides — nada mais
- Politica de privacidade completa: https://slidesync.live/privacy/

CREDITOS
Inspirado por Remote for Slides de Henry Lim (limhenry.xyz/slides/)
